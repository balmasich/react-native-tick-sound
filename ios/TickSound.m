...
RCT_EXTERN_METHOD(playTickSound: (nonnull NSInteger *) soundID)
RCT_EXTERN_METHOD(stopTickSound)
RCT_EXTERN_METHOD(playSound)
...
- (NSDictionary *)constantsToExport
{
 return @{
     ...
     @"Voicemail": @1015,
     @"SMSSent1": @1016,
     @"SMSReceived_Alert01": @1020,
     @"SMSReceived_Alert02": @1021,
     @"SMSReceived_Alert03": @1022,
     @"SMSReceived_Alert04": @1023,
     @"SMSReceived_Alert05": @1024,
     @"SMSReceived_Alert06": @1025,
     @"SMSReceived_Alert07": @1026,
